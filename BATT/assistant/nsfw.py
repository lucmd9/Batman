...
@lucmd9.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@lucmd9.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@lucmd9.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
