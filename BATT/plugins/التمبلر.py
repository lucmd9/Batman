...
async def _(event):
    await event.edit("قائمة اوامر متحـركات كيـوت :\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n ᯽︙ اختر احدى هذه القوائم\n\n- ( `.ك1` ) \n- ( `.ك2` )   \n- (`.ك3`)\n- ( `.ك4`) \n- ( `.ك5` ) \n- ( `.ك6` )\n- ( `.ك7` )\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n⌔︙CH : @angthon"
            )           

@lucmd9.ar_cmd(
    pattern="متحركات انمي$",
    command=("متحركات انمي", plugin_category),)
async def _(event):
    await event.edit("قائمة اوامر متحـركات انمي :\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n ᯽︙ اختر احدى هذه القوائم\n\n- ( `.ن1` ) \n- ( `.ان2` )   \n- ( `.ن3` )\n- ( `.ن4`) \n- ( `.ن5` ) \n- ( `.ن6` )\n-( `.ن7` )\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n⌔︙CH : @angthon"
            )           
    
@lucmd9.ar_cmd(
    pattern="متحركات تافهه$",
    command=("متحركات تافهه", plugin_category),)
async def _(event):
    await event.edit("قائمة اوامر متحـركات تافهه :\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n ᯽︙ اختر احدى هذه القوائم\n\n- ( `.ت1` ) \n- ( `.ت2` )   \n- ( `.ت3` )\n- ( `.ت4`) \n- ( `.ت5` ) \n- ( `.ت6` )\n-\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n⌔︙CH : @angthon"
            )           
