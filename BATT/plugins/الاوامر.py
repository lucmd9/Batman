...
rehu = [
    "قال المهدي(عجل الله فرجه):الدّينُ لمحمّد صلى الله عليه وآله وسلم والهدايةُ لعَلِيٍّ أمير المؤمنين ع، لأنها لهُ وفي عَقِبِه باقيةً إلى يومِ افلقيامة",
    ...
    "عن الامام علي (عليحه السلام) قال : لسانك حصانك، إن صنته صانك",
]
