...
@lucmd9.on(events.NewMessage(pattern=r"^.اختصر (.+) (.+)"))
...
@lucmd9.on(events.NewMessage(pattern=r"^\.(.+)"))
...
@lucmd9.on(events.NewMessage(pattern=r"^.قائمه الاختصار|قائمة الاختصار"))
...
@lucmd9.on(events.NewMessage(pattern=r"^\.امسح (.+)$"))
