...
async def _(event):
    if BATT[0] == "yes":
        ...
        msg0 = await lucmd9.get_messages('@EEObot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await lucmd9.get_messages('@EEObot', limit=1)
...
async def _(event):
    if BATT[0] == "yes":
        ...
        msg0 = await lucmd9.get_messages('@A_MAN9300BOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(2)
        msg1 = await lucmd9.get_messages('@A_MAN9300BOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            list = await lucmd9(GetHistoryRequest(peer=channel_entity, limit=1,
                                                   offset_date=None, offset_id=0, max_id=0, min_id=0, add_offset=0, hash=0))
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await lucmd9.send_message(event.chat_id, f"**لاتوجد قنوات للبوت**")
                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages('@A_MAN9300BOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await lucmd9.send_message("me", f"تم الاشتراك في {chs} قناة")
            except Exception as er:
                await lucmd9.send_message(event.chat_id, f"**خطأ , ممكن تبندت**\n{er}")
        await lucmd9.send_message(event.chat_id, "**تم الانتهاء من التجميع !**")
...
async def _(event):
    if BATT[0] == "yes":
        ...
        msg0 = await lucmd9.get_messages('@MARKTEBOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(3)
        msg1 = await lucmd9.get_messages('@MARKTEBOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages('@MARKTEBOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await lucmd9.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
async def _(event):
    if BATT[0] == "yes":
        ...
        await asyncio.sleep(2)
        msg0 = await lucmd9.get_messages('@qweqwe1919bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(2)
        msg1 = await lucmd9.get_messages('@qweqwe1919bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages('@qweqwe1919bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await lucmd9.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
async def _(event):
    if BATT[0] == "yes":
        ...
        msg0 = await lucmd9.get_messages('@xnsex21bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await lucmd9.get_messages('@xnsex21bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages('@xnsex21bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await lucmd9.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
################################
@lucmd9.ar_cmd(pattern="راتب وعد(?:\s|$)([\s\S]*)")
...
async def send_reham(event):
    ...
    if is_active_status == "True":
        ...
        await send_reham(event)  
@lucmd9.ar_cmd(pattern="ايقاف راتب وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
        delgvar("is_active")
        ...
        await event.edit("**هذا الأمر يمكن استخدامه فقط في المجموعات!**")
@lucmd9.ar_cmd(pattern="بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
        ...
        if is_rio_status != "True":
            addgvar("is_rio", "True")
            await send_thebatman(event)
        else:
            await event.edit("**راتب وعد قيد التشغيل بالفعل!**")
    else:
        await event.edit("**هذا الأمر يمكن استخدامه فقط في المجموعات!**")
async def send_thebatman(event):
    is_rio_status = gvarstatus("is_rio")
    if is_rio_status == "True":
        await event.respond('بخشيش')
        await asyncio.sleep(660)
        await send_thebatman(event)  
@lucmd9.ar_cmd(pattern="ايقاف بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
        delgvar("is_rio")
        ...
        await event.edit("**᯽︙ هذا الأمر يمكن استخدامه فقط في المجموعات!**")
@lucmd9.ar_cmd(pattern="استثمار وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
...
async def Reham_english(event, message):
    ...
    if its_hussein_status == "True":
        ...
        if not message.isnumeric():
            await event.respond("**تنبيه: يجب أن يحتوي رقم الاستثمار على أرقام فقط!**")
@lucmd9.ar_cmd(pattern="ايقاف استثمار وعد(?:\s|$)([\s\S]*)")
...
@lucmd9.ar_cmd(pattern="سرقة وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
...
@lucmd9.ar_cmd(pattern="ايقاف سرقة وعد(?:\s|$)([\s\S]*)")
async def Reham(event):
    if event.is_group:
        its_reda_status = gvarstatus("its_reda")
        if its_reda_status == "True":
...
@lucmd9.ar_cmd(pattern="استثمار بوت وعد")
async def thebatman_money_w3d(event):
    global its_Reham
    if event.is_group:
...
@lucmd9.ar_cmd(pattern="تعطيل استثمار وعد")
...
@lucmd9.on(NewMessage(incoming=True))
async def handle_new_message(event):
    if event.reply_to and event.sender_id == 1421907917:
        reply_msg = await event.get_reply_message()
        owner_id = reply_msg.from_id.user_id
        if owner_id == lucmd9.uid and 'فلوسك صارت' in event.message.message and 'استثمار' in event.message.message:
...
async def _(event):
    if BATT[0] == "yes":
        ...
        await asyncio.sleep(1)
        msg0 = await lucmd9.get_messages('@YY8bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(1)
        msg1 = await lucmd9.get_messages('@YY8bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages('@YY8bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await lucmd9.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
async def _(event):
    if BATT[0] == "yes":
        ...
        await asyncio.sleep(1)
        msg0 = await lucmd9.get_messages('@cn2bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(1)
        msg1 = await lucmd9.get_messages('@cn2bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages('@cn2bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await lucmd9.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع المليار") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await lucmd9.get_entity(bot_username)
        await lucmd9.send_message(bot_username, '/start')
        await asyncio.sleep(4)
        msg0 = await lucmd9.get_messages(bot_username, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await lucmd9.get_messages(bot_username, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await lucmd9.send_message(event.chat_id, f"تم الانتهاء من التجميع ")
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages(bot_username, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
...
async def Hussein(event):
    if event.message.message.startswith("تجميع الجوكر") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await lucmd9.get_entity(bot_username2)
        await lucmd9.send_message(bot_username2, '/start')
        await asyncio.sleep(4)
        msg0 = await lucmd9.get_messages(bot_username2, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await lucmd9.get_messages(bot_username2, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages(bot_username2, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع العقاب") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await lucmd9.get_entity(bot_username3)
        await lucmd9.send_message(bot_username3, '/start')
        await asyncio.sleep(4)
        msg0 = await lucmd9.get_messages(bot_username3, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await lucmd9.get_messages(bot_username3, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages(bot_username3, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع المليون") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await lucmd9.get_entity(bot_username4)
        await lucmd9.send_message(bot_username4, '/start')
        await asyncio.sleep(4)
        msg0 = await lucmd9.get_messages(bot_username4, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await lucmd9.get_messages(bot_username4, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages(bot_username4, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع العرب") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await lucmd9.get_entity(bot_username5)
        await lucmd9.send_message(bot_username5, '/start')
        await asyncio.sleep(4)
        msg0 = await lucmd9.get_messages(bot_username5, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await lucmd9.get_messages(bot_username5, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages(bot_username5, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع السلطان") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await lucmd9.get_entity(bot_username6)
        await lucmd9.send_message(bot_username6, '/start')
        await asyncio.sleep(4)
        msg0 = await lucmd9.get_messages(bot_username6, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await lucmd9.get_messages(bot_username6, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages(bot_username6, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع اسيا") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await lucmd9.get_entity(bot_username7)
        await lucmd9.send_message(bot_username7, '/start')
        await asyncio.sleep(4)
        msg0 = await lucmd9.get_messages(bot_username7, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await lucmd9.get_messages(bot_username7, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await lucmd9(ImportChatInviteRequest(bott))
                msg2 = await lucmd9.get_messages(bot_username7, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
############﷼﷼
@lucmd9.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع المليارز"))
async def _(event):
        ...
        for i in range(100):
            ...
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await lucmd9.send_message(event.chat_id, f"لايوجد قنوات  في البوت | SY")
                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
                ...
                await lucmd9.send_message(event.chat_id, f"خطأ من المحتمل تم حظر الانضمام ")
                break
        await lucmd9.send_message(event.chat_id, "تم الانتهاء من التجميع !")
